...
const APP = `<div class="container">
  <div class="jumbotron">
    <div class="row">
      <div class="col-md-6">
        <h1>Portable HTML Web Components (keyed) – V3 Fast</h1>
      </div>
      <div class="col-md-6">
        <div class="row"></div>
      </div>
...
class BenchRow extends HTMLTableRowElement {
  constructor(rowId, rowLabel) {
    ...
    this.labelLink.textContent = rowLabel;
    ...
    closeLink.append(new BenchIcon());
    ...
    this.append(new BenchCell('col-md-4', this.labelLink));
    this.append(new BenchCell('col-md-1', closeLink));
